...
internal class Vector3iTest {
	...
	@Test
	fun getMagnitude() {
		assertEquals(sqrt(14.0).toInt(), Vector3i(1, -2, 3).magnitude)
	}
	...
	@Test
	fun distance() {
		assertEquals(sqrt(24.0).toInt(), Vector3i(3, 2, 1).distance(Vector3i(1, -2, 3)))
	}
	...
	@Test
	fun getNormalized() {
		assertEquals(1, Vector3i(1, 2, 4).normalized.magnitude)
	}
	
	@Test
	fun getAngle() {
		assertEquals(Math.toRadians(45.0).toInt(), Vector3i(1, 1, 0).angle)
	}
	
	@Test
	fun angleBetween() {
		assertEquals(Math.toRadians(45.0).toInt(), Vector3i(1, 1, 0).angleBetween(Vector3i(1, 0, 0)))
		assertEquals(Math.toRadians(00.0).toInt(), Vector3i(1, 0, 0).angleBetween(Vector3i(1, 0, 0)))
	}
